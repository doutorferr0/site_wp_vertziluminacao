...
<footer class="site-footer" data-ui="site-footer">

  <!-- Logo grande topo -->
  <div class="site-footer__logoWrap">
    <a href="<?php echo esc_url(home_url('/')); ?>" class="site-footer__logoLink">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo/logofooter.png"
  ...
  <div class="site-footer__cols">
    ...
    <div class="site-footer__col">
      <p class="site-footer__colLabel">Contato</p>
      <div class="site-footer__colBody">
        <p>Campinas, SP</p>
        <p><a href="tel:+551932510501">(19) 3251-0501</a></p>
        <p><a href="https://wa.me/5519999778710" target="_blank" rel="noopener">WhatsApp</a></p>
        <p><a href="mailto:contato@vertziluminacao.com.br">contato@vertziluminacao.com.br</a></p>
      </div>
    </div>

    <!-- Linha vertical -->
    <div class="site-footer__vDivider"></div>

    <!-- Col 2: Navegação -->
    <div class="site-footer__col">
      <p class="site-footer__colLabel">Navegação</p>
      <div class="site-footer__colBody site-footer__colBody--grid">
        ...
        <a href="<?php echo esc_url(home_url('/novidades')); ?>">Novidades</a>
    ...
    <!-- Col 3: Redes sociais -->
    <div class="site-footer__col">
      <p class="site-footer__colLabel">Siga-nos</p>
      <div class="site-footer__colBody">
        <a href="https://www.instagram.com/vertziluminacao/" target="_blank" rel="noopener">Instagram</a>
        <a href="https://www.linkedin.com/company/vertziluminacao/" target="_blank" rel="noopener">LinkedIn</a>
      </div>
    </div>
  ...
  <div class="site-footer__bottom">
    <span>© <?php echo date('Y'); ?> Vertz Iluminação. Todos os direitos reservados.</span>
  </div>
...
<!-- FAB -->
<div class="site-fab">
  <a href="https://wa.me/5519999778710?text=Ol%C3%A1%2C%20vim%20atrav%C3%A9s%20do%20site%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es."
     class="site-fab__btn site-fab__btn--wa"
     target="_blank" rel="noopener noreferrer"
     aria-label="WhatsApp" data-label="WhatsApp">
  ...
  <a href="tel:+551932510501"
     class="site-fab__btn site-fab__btn--tel"
     aria-label="Ligar agora" data-label="Ligar">
