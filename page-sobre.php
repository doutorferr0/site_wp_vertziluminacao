...
// ── Campos desta página ─────────────────────────────────────
$hero_img    = vf('sobre_hero_img',     false, $theme_uri . '/assets/images/projetos/sobre-hero.webp');
...
$missao_img  = vf('sobre_missao_img',   false, $theme_uri . '/assets/images/projetos/sobre-missao.webp');
$galeria_01  = vf('sobre_galeria_01',   false, $theme_uri . '/assets/images/projetos/sobre-galeria-01.webp');
$galeria_02  = vf('sobre_galeria_02',   false, $theme_uri . '/assets/images/projetos/sobre-galeria-02.webp');
$galeria_03  = vf('sobre_galeria_03',   false, $theme_uri . '/assets/images/projetos/sobre-galeria-03.webp');
  ...
  <div class="pb-row-wrapper position-relative pt-0 pb-0 mt-0 mb-0" style="--zindex:3;">
    <div style="padding-left:clamp(1.5rem,10vw,18%);padding-right:clamp(1.5rem,10vw,18%);">
      <div class="overflow-clip" style="border-radius:16px;">
        ...
        <img
          src="<?php echo esc_url($theme_uri); ? loading="lazy" decoding="async">/assets/images/projetos/sobre-missao.webp"
    ...
    <div class="pb-row container-fluid" data-scroll data-scroll-offset="80px,0" data-module-delay>
      ...
      <div class="d-grid grid-column-1 grid-column-md-12 grid-gap-12 grid-gap-xl-20 mb-60 mb-md-80" data-scroll data-scroll-offset="60px,0" data-module-delay>
        <div class="col-start-1 col-span-md-5 col-span-xl-10 overflow-clip" style="border-radius:12px;">
          ...
          <img src="<?php echo esc_url($theme_uri); ? loading="lazy" decoding="async">/assets/images/projetos/servico-corporativo.webp"
      ...
      <div class="d-grid grid-column-1 grid-column-md-12 grid-gap-12 grid-gap-xl-20" data-scroll data-scroll-offset="60px,0" data-module-delay>
        ...
        <div class="col-start-1 col-span-md-5 col-span-xl-10 order-md-2 overflow-clip" style="border-radius:12px;">
          ...
          <img src="<?php echo esc_url($theme_uri); ? loading="lazy" decoding="async">/assets/images/projetos/servico-residencial.webp"
